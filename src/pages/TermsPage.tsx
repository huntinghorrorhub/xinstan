  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-sm text-gray-500 mb-8">Last updated: 
December 29, 2025</p>
        ...
        <div className="space-y-8 text-gray-600">
          ...
          <section>
            ...
            <ul className="space-y-3 list-disc pl-5">
              ...
              <li>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to iGram.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to xinstan, accessible from <a href="https://xinstan.com" className="text-pink-600 hover:underline">https://xinstan.com</a>
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5">
              <li>
                By email: <a href="mailto:shreyashnashine81@gmail.com" className="text-pink-600 hover:underline">shreyashnashine81@gmail.com</a>
              </li>
            </ul>
          </section>
        </div>
